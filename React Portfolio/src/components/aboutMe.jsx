        ...
        <section id="about-me" className="container mt-5">
            <div className="row align-items-center">
                ...
                <div className="col-md-8">
                    <h2> Welcome!  </h2>
                    <p> <FontAwesomeIcon icon={faLocationDot} /> Salt Lake City | <FontAwesomeIcon icon={faLaptopCode} /> Full Stack Developer Loading | <FontAwesomeIcon icon={faHeart} /> Wife | <FontAwesomeIcon icon={faBabyCarriage} /> Mother </p>
                    ...
                    <p>It most recently led me to coding. I needed to get out of the house and try something new. I needed to talk to anyone who wasn't a toddler, and I did. I joined an organization called <a href="https://www.tech-moms.org/" target="_blank" class="tech-moms">Tech Moms</a> and started learning to code.</p>
